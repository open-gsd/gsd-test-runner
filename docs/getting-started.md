...
[versions]
linux = "v1.6.0"   # Tester Image version to expect on the Bench
```

Replace `lab-rig-1.local` with your Bench's SSH alias. Replace `v1.6.0` with the current release version.
